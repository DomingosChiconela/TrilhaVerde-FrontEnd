    ...
    <div className="container mx-auto p-6">
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-gray-100 border-b">
                ...
                <th className="p-4 text-left">Data de Criação</th>
            ...
            <tbody>
              {anuncios.map((anuncio) => (
                <tr key={anuncio.id} className="border-b">
                  <td className="p-4">{anuncio.titulo}</td>
                  <td className="p-4">{new Date(anuncio.dataCriacao).toLocaleDateString()}</td>
                  <td className="p-4">{anuncio.status}</td>
      ...
      {editingAnuncio && (
        <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
          <h2 className="text-2xl font-semibold mb-4">Editar Anúncio</h2>
